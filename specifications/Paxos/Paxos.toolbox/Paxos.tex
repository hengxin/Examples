...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 leaders or learners.
 It refines the spec in \ensuremath{Voting}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\EXTENDS} Integers ,\, TLC}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\CONSTANT} Value ,\,
 Acceptor ,\, Quorum}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} {\ASSUME} QuorumAssumption
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} \.{\land}\@s{10.73}
 \A\, Q \.{\in} Quorum \.{:} Q \.{\subseteq} Acceptor}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} \.{\land}\@s{10.73}
 \A\, Q1 ,\, Q2 \.{\in} Quorum \.{:} Q1 \.{\cap} Q2 \.{\neq} \{ \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} Ballot \.{\defeq}\@s{4.1}
 Nat}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} None \.{\defeq} {\CHOOSE} v
 \.{:} v \.{\notin} Ballot}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} Message \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{40.90} [ type\@s{2.83}
 \.{:} \{\@w{1a} \} ,\, bal\@s{1.93} \.{:} Ballot ]}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} \.{\cup}\@s{13.39}
 [ type\@s{2.83} \.{:} \{\@w{1b} \} ,\, acc \.{:} Acceptor ,\, bal \.{:}
 Ballot ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{43.68} mbal \.{:} Ballot
 \.{\cup} \{ \.{-} 1 \} ,\, mval \.{:} Value \.{\cup} \{ None \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\cup}\@s{13.39}
 [ type\@s{2.83} \.{:} \{\@w{2a} \} ,\, bal\@s{1.93} \.{:} Ballot ,\, val
 \.{:} Value ]}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\cup}\@s{13.39}
 [ type\@s{2.83} \.{:} \{\@w{2b} \} ,\, acc \.{:} Acceptor ,\, bal \.{:}
 Ballot ,\, val \.{:} Value ]}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} {\VARIABLE} maxBal
 ,\,\@s{7.43}}%
\@y{\@s{0}%
 \ensuremath{maxBal[a]}: the largest ballot number a has seen
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{46.84} maxVBal ,\,}%
\@y{\@s{0}%
 \ensuremath{{\langle}maxVBal[a],\, maxVal[a]{\rangle}} is the vote with the
 largest
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{46.84} maxVal
 ,\,\@s{7.80}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{46.84} msgs\@s{25.43}}%
\@y{\@s{0}%
 The set of all messages that have been sent.
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} Send ( m ) \.{\defeq} msgs
 \.{'} \.{=} msgs \.{\cup} \{ m \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} vars \.{\defeq} {\langle}
...
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\land} maxBal
 \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\land} maxVBal
 \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \.{\land} maxVal
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}} Phase1a ( b ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{16.4} \.{\land}\@s{9.81}
 Send ( [ type \.{\mapsto}\@w{1a} ,\, bal \.{\mapsto} b ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \.{\land}\@s{9.81}
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} Phase1b ( a ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{16.4} \.{\land}\@s{9.16}
 \E\, m \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{40.77} \.{\land} m . type
 \.{=}\@w{1a}}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{40.77} \.{\land} m . bal
 \.{>} maxBal [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{40.77} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]\@s{8.2}}%
\@y{\@s{0}%
 make promise
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{40.77} \.{\land} Send ( [
 type\@s{2.83} \.{\mapsto}\@w{1b} ,\, acc \.{\mapsto} a ,\, bal \.{\mapsto} m
 . bal ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{80.54} mbal \.{\mapsto}
 maxVBal [ a ] ,\, mval \.{\mapsto} maxVal [ a ] ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{16.4} \.{\land}\@s{9.16}
 {\UNCHANGED} {\langle} maxVBal ,\, maxVal {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} NoBackInTime \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} \A\, m \.{\in} msgs
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}} P2C ( b ,\, v ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{25.30} \E\, Q \.{\in}
 Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{36.62} \.{\LET} Q2bv
 \.{\defeq} \{ m \.{\in} msgs \.{:} m . type \.{=}\@w{2b} \.{\land} m . acc
 \.{\in} Q \.{\land} m . bal \.{<} b \}}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{36.62} \.{\IN} \.{\lor}
 Q2bv \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{57.02} \.{\lor} \E\,
 m\@s{7.71} \.{\in} Q2bv \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{75.36} \.{\land} m . val
 \.{=} v}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{75.36} \.{\land} \A\,
 mm\@s{0.67} \.{\in} Q2bv \.{:} m . bal \.{\geq} mm . bal}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}} Phase2a ( b ,\, v )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{8.2} \.{\land} {\lnot}
 \E\, m \.{\in} msgs\@s{7.89} \.{:} m . type \.{=}\@w{2a} \.{\land} m . bal
 \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{8.2} \.{\land} \E\, Q
 \.{\in} Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{26.53} \.{\LET} Q1b
 \.{\defeq} \{ m \.{\in} msgs \.{:} m . type \.{=}\@w{1b} \.{\land} m . acc
 \.{\in} Q \.{\land} m . bal \.{=} b \}}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{38.83} Q1bv\@s{3.05}
 \.{\defeq} \{ m \.{\in} Q1b \.{:} m . mbal \.{\geq} 0 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{26.53} \.{\IN}\@s{4.1}
 \.{\land} \A\, a \.{\in} Q \.{:} \E\, m \.{\in} Q1b \.{:} m . acc \.{=} a}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{51.03} \.{\land}
 \.{\lor} Q1bv \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{62.14} \.{\lor} \E\,
 m\@s{7.71} \.{\in} Q1bv \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{81.45} \.{\land} m .
 mval \.{=} v}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{81.45} \.{\land} \A\, mm
 \.{\in} Q1bv \.{:} m . mbal \.{\geq} mm . mbal}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{8.2} \.{\land} Send ( [
 type \.{\mapsto}\@w{2a} ,\, bal \.{\mapsto} b ,\, val \.{\mapsto} v ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{8.2} \.{\land} Assert (
 P2C ( b ,\, v ) ,\,\@w{P2C\ Fails!} )}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{8.2} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxVBal ,\, maxVal {\rangle}}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}} Phase2b ( a ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{16.4} \.{\land}\@s{9.16}
 \E\, m \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{40.77} \.{\land} m .
 type \.{=}\@w{2a}}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{40.77} \.{\land} m . bal
 \.{\geq} maxBal [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{40.77} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}\@s{40.77} \.{\land} maxVBal
 \.{'} \.{=} [ maxVBal {\EXCEPT} {\bang} [ a ] \.{=} m . bal ]}%
 \@x{\makebox[0pt][r]{\scriptsize 144\hspace{1em}}\@s{40.77} \.{\land} Assert
 ( maxVBal \.{'} [ a ] \.{\geq} maxVBal [ a ] ,\,\@w{Non{-}Increasing\
 Error!} )}%
 \@x{\makebox[0pt][r]{\scriptsize 145\hspace{1em}}\@s{40.77} \.{\land} maxVal
 \.{'} \.{=} [ maxVal {\EXCEPT} {\bang} [ a ] \.{=} m . val ]}%
 \@x{\makebox[0pt][r]{\scriptsize 146\hspace{1em}}\@s{40.77} \.{\land} Send (
 [ type \.{\mapsto}\@w{2b} ,\, acc \.{\mapsto} a ,\, bal \.{\mapsto} m . bal
 ,\, val \.{\mapsto} m . val ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 147\hspace{1em}}\@s{16.4} \.{\land}\@s{9.16}
 {\UNCHANGED} {\langle} {\rangle}}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\@x{\makebox[0pt][r]{\scriptsize 154\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 155\hspace{1em}}\@s{16.4} \.{\lor} \E\, b
 \.{\in} Ballot \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 156\hspace{1em}}\@s{31.61} \.{\lor} Phase1a
 ( b )}%
 \@x{\makebox[0pt][r]{\scriptsize 157\hspace{1em}}\@s{31.61} \.{\lor} \E\, v
 \.{\in} Value \.{:} Phase2a ( b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}}\@s{16.4} \.{\lor} \E\, a
 \.{\in} Acceptor \.{:} Phase1b ( a ) \.{\lor} Phase2b ( a )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 160\hspace{1em}} Spec \.{\defeq} Init
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}} votes \.{\defeq} [ a
 \.{\in} Acceptor \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 173\hspace{1em}}\@s{48.30} \{ {\langle} m .
 bal ,\, m . val {\rangle} \.{:} m \.{\in} \{ mm \.{\in} msgs \.{:} \.{\land}
 mm . type \.{=}\@w{2b}}%
 \@x{\makebox[0pt][r]{\scriptsize 174\hspace{1em}}\@s{212.90} \.{\land} mm .
 acc \.{=} a \} \} ]}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 181\hspace{1em}} V \.{\defeq} {\INSTANCE}
 Voting}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 183\hspace{1em}} {\THEOREM} Spec
 \.{\implies} V {\bang} Spec}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 189\hspace{1em}} Inv \.{\defeq} \.{\land}
 TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 190\hspace{1em}}\@s{34.04} \.{\land} \A\,
 a\@s{3.06} \.{\in} Acceptor \.{:} {\IF} maxVBal [ a ] \.{=} \.{-} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 191\hspace{1em}}\@s{129.72} \.{\THEN} maxVal
 [ a ] \.{=} None}%
 \@x{\makebox[0pt][r]{\scriptsize 192\hspace{1em}}\@s{129.72} \.{\ELSE}
 {\langle} maxVBal [ a ] ,\, maxVal [ a ] {\rangle} \.{\in} votes [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 193\hspace{1em}}\@s{34.04} \.{\land} \A\, m
 \.{\in} msgs \.{:}}%
