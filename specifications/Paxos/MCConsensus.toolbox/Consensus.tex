...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\VARIABLE} chosen\@s{2.58}}%
\@y{\@s{0}%
 the set of all values that have been chosen
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 IsFiniteSet ( chosen )}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 chosen \.{\subseteq} Value}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} Init\@s{4.12} \.{\defeq}
 chosen \.{=} \{ \}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{16.4} \.{\land} chosen
 \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.4} \.{\land} \E\, v
 \.{\in} Value \.{:} chosen \.{'} \.{=} \{ v \}}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Spec \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ chosen}}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} Inv \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{15.15} \.{\land} TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{15.15} \.{\land}
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} {\THEOREM} Invariance
 \.{\defeq} Spec \.{\implies} {\Box} Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@pfstepnum{1}{1.}\  Init
 \.{\implies} Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@pfstepnum{1}{2.}\  Inv
 \.{\land} [ Next ]_{ chosen} \.{\implies} Inv \.{'}}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@pfstepnum{1}{3.}\  {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{8.2}\@pfstepnum{2}{1.}\ 
 Inv \.{\land} {\Box} [ Next ]_{ chosen} \.{\implies} {\Box} Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{1}{2}\ }%
\@y{\@s{0}%
 and a TLA proof rule
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{8.2}\@pfstepnum{2}{2.}\ 
 {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{1}{1} ,\,\@pfstepnum{2}{1}\ \@s{4.1}}%
\@y{\@s{0}%
 and simple logic
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} Success \.{\defeq}
 {\Diamond} ( chosen \.{\neq} \{ \} )}%
\@y{\@s{0}%
 Liveness: a value is eventually chosen
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} LiveSpec \.{\defeq} Spec
 \.{\land} {\WF}_{ chosen} ( Next )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} {\THEOREM} LivenessTheorem
 \.{\defeq} LiveSpec \.{\implies}\@s{4.1} Success}%
