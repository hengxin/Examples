...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\EXTENDS} Integers}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\CONSTANTS}}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} Value ,\,\@s{17.58}}%
\@y{\@s{0}%
 The set of choosable values.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} Acceptor
 ,\,\@s{4.1}}%
\@y{\@s{0}%
 A set of processes that will choose a value.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} Quorum\@s{12.07}}%
\@y{\@s{0}%
 The set of ``quorums'', where a ``quorum'' is a ``large enough'' set of
 acceptors.
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} {\ASSUME} QuorumAssumption
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} \.{\land}\@s{10.73}
 \A\, Q \.{\in} Quorum \.{:} Q \.{\subseteq} Acceptor}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{16.4} \.{\land}\@s{10.73}
 \A\, Q1 ,\, Q2 \.{\in} Quorum \.{:} Q1 \.{\cap} Q2 \.{\neq} \{ \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} {\THEOREM} QuorumNonEmpty
 \.{\defeq} \A\, Q \.{\in} Quorum \.{:} Q \.{\neq} \{ \}}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} Ballot \.{\defeq} Nat}%
\@y{\@s{0}%
...
Each acceptor can cast one or more votes,
 where each vote cast by an acceptor has the form \ensuremath{{\langle}b,\,
 v{\rangle}
 } indicating that the acceptor has voted for value \ensuremath{v} in ballot
 \ensuremath{b}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} votes ,\,\@s{9.11}}%
\@y{\@s{0}%
 \ensuremath{votes[a]}: the set of votes cast by acceptor a
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} maxBal\@s{4.10}}%
\@y{\@s{0}%
 \ensuremath{maxBal[a]}: a ballot number.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{54.16}}%
\@y{\@s{0}%
 Acceptor a will cast further votes only in ballots numbered
 \ensuremath{\.{\geq} maxBal[a]}.
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\land} votes
 \.{\in} [ Acceptor \.{\rightarrow} {\SUBSET} ( Ballot \.{\times} Value ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\land} maxBal
 \.{\in} [ Acceptor \.{\rightarrow} Ballot \.{\cup} \{ \.{-} 1 \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} VotedFor ( a ,\, b ,\, v )
 \.{\defeq} {\langle} b ,\, v {\rangle} \.{\in} votes [ a ]}%
\@y{\@s{0}%
 Acceptor a has voted for \ensuremath{v} in ballot \ensuremath{b}.
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} ChosenAt ( b ,\, v )
 \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{{\langle}b,\, v{\rangle}} is chosen if a quorum of acceptors
 have voted for it.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \E\, Q \.{\in}
 Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{27.72} \A\, a \.{\in} Q
 \.{:} VotedFor ( a ,\, b ,\, v )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} chosen \.{\defeq}}%
\@y{\@s{0}%
 The set of values that have been chosen.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \{ v \.{\in} Value
 \.{:} \E\, b \.{\in} Ballot \.{:} ChosenAt ( b ,\, v ) \}}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} DidNotVoteAt ( a ,\, b )
 \.{\defeq}}%
\@y{\@s{0}%
 The acceptor a did not vote (for any value) at ballot \ensuremath{b}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} \A\, v \.{\in}
 Value \.{:} {\lnot} VotedFor ( a ,\, b ,\, v )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} CannotVoteAt ( a ,\, b )
 \.{\defeq}}%
\@y{\@s{0}%
 The acceptor a cannot vote (for any value) at ballot \ensuremath{b}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} \.{\land}
 DidNotVoteAt ( a ,\, b )}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} \.{\land} maxBal [
 a ] \.{>} b}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} NoneOtherChoosableAt ( b ,\,
 v ) \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{ChosenAt(b,\, w)} is not and can never become true for any
 \ensuremath{w \.{\neq} v}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \E\, Q \.{\in}
 Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{27.72} \A\, a \.{\in} Q
 \.{:} VotedFor ( a ,\, b ,\, v ) \.{\lor} CannotVoteAt ( a ,\, b )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} {\THEOREM} ChoosableThm
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{55.02} \A\, b \.{\in}
 Ballot ,\, v \.{\in} Value \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{62.24} ChosenAt ( b ,\, v
 ) \.{\implies} NoneOtherChoosableAt ( b ,\, v )}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} SafeAt ( b ,\, v )
 \.{\defeq}}%
\@y{\@s{0}%
 No value other than \ensuremath{v} has been or can ever be chosen in any
 ballot \ensuremath{\.{<} b}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \A\, c \.{\in} 0
 \.{\dotdot} ( b \.{-} 1 ) \.{:} NoneOtherChoosableAt ( c ,\, v )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}} {\THEOREM} AllSafeAtZero
 \.{\defeq} \A\, v \.{\in} Value \.{:} SafeAt ( 0 ,\, v )}%
\@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} OneVote \.{\defeq} \A\, a
 \.{\in} Acceptor ,\, b \.{\in} Ballot ,\, v ,\, w \.{\in} Value \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{64.45} VotedFor ( a ,\, b
 ,\, v ) \.{\land} VotedFor ( a ,\, b ,\, w ) \.{\implies} ( v \.{=} w )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} OneValuePerBallot
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \A\, a1 ,\, a2
 \.{\in} Acceptor ,\, b \.{\in} Ballot ,\, v1 ,\, v2 \.{\in} Value \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{23.62} VotedFor ( a1 ,\,
 b ,\, v1 ) \.{\land} VotedFor ( a2 ,\, b ,\, v2 ) \.{\implies} ( v1 \.{=} v2
 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}} {\THEOREM} OneValuePerBallot
 \.{\implies} OneVote}%
\@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}} VotesSafe \.{\defeq} \A\, a
 \.{\in} Acceptor ,\, b \.{\in} Ballot ,\, v \.{\in} Value \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{73.15} VotedFor ( a ,\, b
 ,\, v ) \.{\implies} SafeAt ( b ,\, v )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} {\THEOREM}
 VotesSafeImpliesConsistency \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{55.02} \.{\land} TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{55.02} \.{\land}
 VotesSafe}%
\@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{55.02} \.{\land} OneVote}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{55.02} \.{\implies}
 \.{\lor} chosen \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{70.57} \.{\lor} \E\, v
 \.{\in} Value \.{:} chosen \.{=} \{ v \}}%
\@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} ShowsSafeAt ( Q ,\, b ,\, v
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} \.{\land} \A\, a
 \.{\in} Q \.{:} maxBal [ a ] \.{\geq} b}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{16.4} \.{\land} \E\,
 c\@s{0.71} \.{\in} \.{-} 1 \.{\dotdot} ( b \.{-} 1 ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{31.61} \.{\land} ( c
 \.{\neq} \.{-} 1 ) \.{\implies} \E\, a \.{\in} Q \.{:} VotedFor ( a ,\, c
 ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{31.61} \.{\land} \A\, d
 \.{\in} ( c \.{+} 1 ) \.{\dotdot} ( b \.{-} 1 ) ,\, a \.{\in} Q \.{:}
 DidNotVoteAt ( a ,\, d )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}} {\THEOREM} ShowsSafety
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{55.02} TypeOK \.{\land}
 VotesSafe \.{\land} OneValuePerBallot \.{\implies}}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{67.32} \A\, Q \.{\in}
 Quorum ,\, b \.{\in} Ballot ,\, v \.{\in} Value \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{75.52} ShowsSafeAt ( Q
 ,\, b ,\, v ) \.{\implies} SafeAt ( b ,\, v )}%
\@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{16.4} \.{\land} votes
 \.{=} [ a \.{\in} Acceptor \.{\mapsto} \{ \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{16.4} \.{\land} maxBal
 \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}} IncreaseMaxBal ( a ,\, b )
 \.{\defeq}}%
\@y{\@s{0}%
 Acceptor a is allowed ot increase \ensuremath{maxBal[a]} to a ballot number.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{16.4} \.{\land} b \.{>}
 maxBal [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{16.4} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} b ]}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} votes}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}} VoteFor ( a ,\, b ,\, v )
 \.{\defeq}}%
\@y{\@s{0}%
 Acceptor a votes for \ensuremath{v} in ballot \ensuremath{b}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{16.4} \.{\land}\@s{8.35}
 maxBal [ a ] \.{\leq} b}%
\@y{\@s{0}%
 The acceptor cannot cast a vote in a ballot less than \ensuremath{maxBal[a]
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{16.4} \.{\land}\@s{8.35}
 \A\, vt \.{\in} votes [ a ] \.{:} vt [ 1 ] \.{\neq} b}%
\@y{\@s{0}%
 to maintain \ensuremath{OneValuePerBallot
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{16.4} \.{\land}\@s{8.35}
 \A\, c \.{\in} Acceptor \.{\,\backslash\,} \{ a \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{44.06} \A\, vt \.{\in}
 votes [ c ] \.{:} ( vt [ 1 ] \.{=} b ) \.{\implies} ( vt [ 2 ] \.{=} v )}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{16.4} \.{\land}\@s{8.35}
 \E\, Q \.{\in} Quorum \.{:} ShowsSafeAt ( Q ,\, b ,\, v )\@s{8.2}}%
\@y{\@s{2.5}%
 to maintain \ensuremath{VotesSafe
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{16.4} \.{\land}\@s{8.35}
 votes \.{'} \.{=} [ votes {\EXCEPT} {\bang} [ a ] \.{=} @ \.{\cup} \{
 {\langle} b ,\, v {\rangle} \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{16.4} \.{\land}\@s{8.35}
 maxBal \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} b ]}%
\@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{16.4} \E\, a \.{\in}
 Acceptor ,\, b \.{\in} Ballot \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{27.72} \.{\lor}
 IncreaseMaxBal ( a ,\, b )}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{27.72} \.{\lor} \E\, v
 \.{\in} Value \.{:} VoteFor ( a ,\, b ,\, v )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}} Spec \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ {\langle} votes ,\, maxBal {\rangle}}}%
\@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}} Inv \.{\defeq} TypeOK
 \.{\land} VotesSafe \.{\land} OneValuePerBallot}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}} {\THEOREM} Invariance
 \.{\defeq} Spec \.{\implies} {\Box} Inv}%
\@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}} C \.{\defeq} {\INSTANCE}
 Consensus}%
\@y{\@s{0}%
 \ensuremath{{\WITH}} \ensuremath{Value \.{\leftarrow} Value},
 \ensuremath{chosen \.{\leftarrow} chosen
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}} {\THEOREM} Spec
 \.{\implies} C {\bang} Spec}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@pfstepnum{1}{1.}\  Inv
 \.{\land} Init \.{\implies} C {\bang} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}\@pfstepnum{1}{2.}\  Inv
 \.{\land} [ Next ]_{ {\langle} votes ,\, maxBal {\rangle}} \.{\implies} [ C
 {\bang} Next ]_{ chosen}}%
\@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@pfstepnum{1}{3.}\  {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{8.2}\@pfstepnum{2}{1.}
 {\Box} Inv \.{\land} {\Box} [ Next ]_{ {\langle} votes ,\, maxBal {\rangle}}
 \.{\implies} {\Box} [ C {\bang} Next ]_{ chosen}}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{1}{2}\ }%
\@y{\@s{0}%
 and temporal reasoning
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{8.2}\@pfstepnum{2}{2.}
 {\Box} Inv \.{\land} Spec \.{\implies} C {\bang} Spec}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{2}{1} ,\,\@pfstepnum{1}{1}\ }%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@s{8.2}\@pfstepnum{2}{3.}\ 
 {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{2}{2} ,\, Invariance}%
\@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}}\bottombar\@xx{}%
\@pvspace{8.0pt}%
\end{document}
