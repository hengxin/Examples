...
\setboolean{shading}{true}
 ...
 {\MODULE} SafeRegister}\moduleRightDash\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\CONSTANTS}}%
\@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}}\@s{16.4} Writer ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}}\@s{16.4} Reader ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}}\@s{16.4} T}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} notValue \.{\defeq} {\CHOOSE}
 t \.{:} t \.{\notin} T}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
...
\pcalshadingtrue
\csyntaxtrue
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} {\p@mmalgorithm} Register
 {\p@lbrace}}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} {\p@variables} r
 \.{=} notValue ,\, result \.{=} notValue {\p@semicolon}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{16.4} {\p@process}
 {\p@lparen} W \.{\in} Writer {\p@rparen}}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} {\p@lbrace}}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{32.8}
 a\@s{.5}\textrm{:}\@s{3} r \.{:=} notValue {\p@semicolon}}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{32.8}
 b\@s{.5}\textrm{:}\@s{3}\@s{0.64} {\p@with} {\p@lparen} v \.{\in} T
 {\p@rparen}}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{71.15} {\p@lbrace} r
 \.{:=} v {\p@rbrace}}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} {\p@process}
 {\p@lparen} R \.{\in} Reader {\p@rparen} {\p@lbrace}}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{32.8}
 c\@s{.5}\textrm{:}\@s{3} {\p@with} {\p@lparen} v \.{\in} {\IF} r \.{=}
 notValue \.{\THEN} T \.{\ELSE} \{ r \} {\p@rparen}}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{70.43} {\p@lbrace} result
 \.{:=} v {\p@rbrace}}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} {\p@rbrace}}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} {\p@rbrace}}%
\@y{}%
\@xx{}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} {\VARIABLES} r ,\, result
 ,\, pc}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} vars \.{\defeq} {\langle} r
 ,\, result ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} ProcSet \.{\defeq} ( Writer
 ) \.{\cup} ( Reader )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{35.70} \.{\land} r \.{=}
 notValue}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{35.70} \.{\land} result
 \.{=} notValue}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{35.70} \.{\land} pc \.{=}
 [ self \.{\in} ProcSet \.{\mapsto} {\CASE} self \.{\in} Writer\@s{0.5}
 \.{\rightarrow}\@w{a}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{160.39} {\Box}\@s{10.30}
 self \.{\in} Reader \.{\rightarrow}\@w{c} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} a ( self )\@s{5.94}
 \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{a}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{54.92} \.{\land} r \.{'}
 \.{=} notValue}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{54.92} \.{\land} pc \.{'}
 \.{=} [ pc {\EXCEPT} {\bang} [ self ] \.{=}\@w{b} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{54.92} \.{\land}
 {\UNCHANGED} result}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} b ( self )\@s{6.59}
 \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{b}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{54.92} \.{\land} \E\,
 v\@s{3.40} \.{\in} T \.{:}}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{74.23} r \.{'} \.{=} v}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{54.92} \.{\land} pc \.{'}
 \.{=} [ pc {\EXCEPT} {\bang} [ self ] \.{=}\@w{Done} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{54.92} \.{\land}
 {\UNCHANGED} result}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}} W ( self ) \.{\defeq} a (
 self ) \.{\lor} b ( self )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} c ( self )\@s{6.65}
 \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{c}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{54.92} \.{\land} \E\, v
 \.{\in} {\IF} r \.{=} notValue \.{\THEN} T \.{\ELSE} \{ r \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{74.23} result \.{'} \.{=}
 v}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{54.92} \.{\land} pc \.{'}
 \.{=} [ pc {\EXCEPT} {\bang} [ self ] \.{=}\@w{Done} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{54.92} \.{\land} r \.{'}
 \.{=} r}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} R ( self )\@s{4.14}
 \.{\defeq} c ( self )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} Next \.{\defeq} ( \E\, self
 \.{\in} Writer \.{:} W ( self ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{47.82} \.{\lor} ( \E\,
 self \.{\in} Reader \.{:} R ( self ) )}%
\@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{47.82} \.{\lor}}%
\@y{\@s{0}%
 Disjunct to prevent deadlock on termination
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{58.93} ( ( \A\, self
 \.{\in} ProcSet \.{:} pc [ self ] \.{=}\@w{Done} ) \.{\land} {\UNCHANGED}
 vars )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} Termination \.{\defeq}
 {\Diamond} ( \A\, self \.{\in} ProcSet \.{:} pc [ self ] \.{=}\@w{Done} )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}}%
\@y{\@s{0}%
 END TRANSLATION
}%
\@xx{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Jul} 06
 09:21:10 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Jul} 03
 11:03:58 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
